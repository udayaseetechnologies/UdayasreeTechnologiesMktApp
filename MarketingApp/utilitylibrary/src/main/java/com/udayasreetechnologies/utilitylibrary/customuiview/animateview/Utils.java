...
public class Utils {
    ...
    public static List<Icon> getIcons() {
        ...
        icons.add(new Icon(R.drawable.anim_heart_on, R.drawable.anim_heart_off, IconType.Heart));
        icons.add(new Icon(R.drawable.anim_star_on, R.drawable.anim_star_off, IconType.Star));
        icons.add(new Icon(R.drawable.anim_thumb_on, R.drawable.anim_thumb_off, IconType.Thumb));
